...
router.get('/messagesAmount', (req, res) => {
    ...
    userController
        .messagesAmount(dialogID, username)
...
router.post('/dialogLastVisit', (req, res) => {
    ...
    userController
        .dialogLastVisit(dialogID, username)
...
router.post('/addMessage', (req, res) => {
    ...
    userController
        .addMessage(username, message, dialogID, token)
