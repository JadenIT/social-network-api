...
var EntryController = (function () {
    ...
    EntryController.prototype.create = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            jwt.verify(token, process.env.JWT_KEY, function (error, decoded) { return __awaiter(_this, void 0, void 0, function () {
                var usernameID;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4, this.getUserIdByUsername(username)
